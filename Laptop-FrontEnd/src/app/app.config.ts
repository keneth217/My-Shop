...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideIcons({ heroUsers, heroArrowRightCircle, heroPlaySolid, heroBars4,heroChevronDown,heroChevronUp, heroDocument, heroSquares2x2, heroPlusCircle, heroPercentBadge, heroCurrencyDollar, heroXMark }),
